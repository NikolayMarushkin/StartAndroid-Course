package com.course.p0491simpleadaptercustom1;
...
public class MainActivity extends AppCompatActivity {
    ...
    final int positive = R.drawable.ic_arrow_upward_black_24dp;
    final int negative = R.drawable.ic_arrow_downward_black_24dp;
